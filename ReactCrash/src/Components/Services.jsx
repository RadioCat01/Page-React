    ...
    <section id="services" className="relative py-24 sm:py-32">
      ...
      <div ref={ref} className={`relative z-10 max-w-7xl mx-auto px-6 ${isVisible ? '' : ''}`}>
        ...
        <div className={`text-center mb-16 ${isVisible ? 'animate-slide-up' : 'opacity-0'}`}>
          <p className="text-orange-600 font-semibold text-sm uppercase tracking-widest mb-3">What We Do</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((svc, i) => (
            ...
            >
              ...
              <h3 className="font-display text-lg font-semibold text-slate-800 mb-2">{svc.title}</h3>
