    ...
    <section className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-16 ${isVisible ? 'animate-slide-up' : 'opacity-0'}`}>
          <p className="text-orange-600 font-semibold text-sm uppercase tracking-widest mb-3">Why Choose Us</p>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {reasons.map((r, i) => (
            ...
            >
              {/* Icon badge */}
              <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-500/20 to-orange-600/20 border border-orange-500/20 flex items-center justify-center">
                <r.icon className="text-orange-600 text-2xl" />
              </div>
              <div>
                <h3 className="font-display text-lg font-semibold text-slate-800 mb-1">{r.title}</h3>
